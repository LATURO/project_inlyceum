...
function denaani_admin_menu() {
	add_theme_page( 'Z.com WordPress Hosting', 'More', 'read','more', 'denaani_menu_more' );
}
...
wp_add_dashboard_widget('denaani_dashboard_widget', 'Z.com WordPress Hosting', 'denaani_dashboard_widget_function');
